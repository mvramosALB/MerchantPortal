...
<html>
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Merchant Class</h1>
    <p class="mb-4"><a target="_blank" href="https://datatables.net"></a></p>
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
            <h6 class="m-0 font-weight-bold text-primary">List</h6>
            <a onclick="AddMaintenance('CLASS')"class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"  data-toggle="modal" data-target="#AddMaintenanceModal"><i
                    class="fas fa-plus-square fa-sm text-white-50"></i> Add Class</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered MFDatatable" id="MFCLASSDatatable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Description</th>
    ...
    <script>
       $('#MFCLASSDatatable').DataTable({
            ...
            "iDisplayStart": 0,
            "serverSide": true,
            "sAjaxSource": "MerchantClassDatatables",
            "sServerMethod": "POST",
            ...
            "aoColumns": [
                {
                    ...
                    "mRender": function (data, type, full) {
                        var functionOnclick1 = "EditMF('CLASS','" + full[0] + "')";//view
                        var functionOnclick2 = "DisableDisableMF('CLASS','" + full[0] + "')";//disable
                        var functionOnclick3 = "EnableMF('CLASS','" + full[0] + "')";//enable
                        var returnString = '';
                        if (full[2] === 'Active') {
