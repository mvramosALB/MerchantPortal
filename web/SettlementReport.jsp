...
<html lang="en">
    ...
    <head>
        <title>AllBank MOS - Settlement Report</title>
    ...
    <body id="page-top" style="font-size: 12px;">
                        ...
                        <c:otherwise>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="card-header d-sm-flex align-items-center justify-content-between " id="headerdiv">
                                    <h2 class="h5 mb-2 text-gray-800">Settlement Report       </h2> <a   onclick="ReloadTable()" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" ><i class="fas fa-refresh fa-sm text-white-50"></i> Refresh</a>
</div>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3 ">
                                        ...
                                        <c:forEach var = "rowMerchantAccounts" items = "${resultMerchantAccounts.rows}">
                                            <c:set var="RATETYPE" value="${rowMerchantAccounts.RATETYPE}"/>
                                            <c:set var="RATEVALUE" value="${rowMerchantAccounts.RATEVALUE}"/>
                                        </c:forEach>
                                        <div class="row" >
                                            <input type="hidden" id="rvt" value="${RATETYPE}">  
                                            <input type="hidden" id="rvv" value="${RATEVALUE}">  
        ...
        <script src="js/settlementreport.js"></script>
        <script>
