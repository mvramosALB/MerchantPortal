...
<html lang="en">
    ...
    <head>
        <title>AllBank MOS - Merchant/Partners List</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Merchants/Partners List</h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="MerchantsListDatatables" width="100%" cellspacing="0" style="font-size: 12px;">
                                        <thead>
                                            <tr>
                                                <th>Partner Name</th>
                                                <th>Merchant Type</th>
                     ...
                     <div id="dynamicForm">
                        <form id="formredirect" action="MerchantProfile" method="POST">
   ...
   <%@ include file="Includes/ChangePasswordModal.jsp" %>
     <%@ include file="Includes/scripts.jsp" %>
        ...
        <script src="js/MerchantList.js"></script>
    </body>
