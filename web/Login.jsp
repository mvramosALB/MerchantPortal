...
<html lang="en">
    <head>
        ...
        <title>P2M Merchant On-Boarding</title>
    ...
    <body class="bg-gradient-primary" style="background-image: url(https://portal.allbank.ph/ALB/MOS/bg/MOSInternalBackground.png)">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Welcome to AllBank POS/P2M Merchant On-Boarding!</h1>
                                        </div>
