...
<html>
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!--Get MainMenuGroup-->
        <sql:query dataSource = "${ALBIntranetDB2}" var = "resultMainMenuGroups">
        ...
        <c:forEach var = "rowMainMenuGroups" items = "${resultMainMenuGroups.rows}">
            ...
            <!--GetMainMenus-->
            <sql:query dataSource = "${ALBIntranetDB2}" var = "resultMainMenuSubMenuCount">
            ...
            <c:forEach var = "rowMainMenuSubMenuCount" items = "${resultMainMenuSubMenuCount.rows}">
                ...
                <c:choose>
                    <c:when test="${SubMenuCount < 1}">
                        <!--GetMainMenuDetails-->
                        <sql:query dataSource = "${ALBIntranetDB2}" var = "resultMainMenuDetails">
