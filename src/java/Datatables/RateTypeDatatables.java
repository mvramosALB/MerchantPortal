 ...
 */
public class RateTypeDatatables extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] columnNames = {"ID","RATE_DESCRIPTION", "ACTIVESTATUS"};
    ...
    public int getTotalRecordCount() throws SQLException, ClassNotFoundException {
        ...
        int totalRecords = -1;
        String sql = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_RATETYPE" + "";
    ...
    public JSONObject getPersonDetails(int totalRecords, HttpServletRequest request)
        ...
        con = DBConnection.getConnection();
        String sql = "select * from VW_RATETYPE";

        String globeSearch = " where (RATE_DESCRIPTION like '%" + GLOBAL_SEARCH_TERM + "%')";
        ...
        while (rs.next()) {
            ...
            ja.put(rs.getString("RATE_DESCRIPTION"));
        ...
        String query = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_RATETYPE";
