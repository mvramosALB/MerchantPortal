 ...
 */
public class BusinessTypeDatatables extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] columnNames = {"ID","TB_TYPE", "ACTIVESTATUS"};
    ...
    public int getTotalRecordCount() throws SQLException, ClassNotFoundException {
        ...
        int totalRecords = -1;
        String sql = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_BUSINESSTYPE" + "";
    ...
    public JSONObject getPersonDetails(int totalRecords, HttpServletRequest request)
        ...
        con = DBConnection.getConnection();
        String sql = "select * from VW_BUSINESSTYPE";

        String globeSearch = " where (TB_TYPE like '%" + GLOBAL_SEARCH_TERM + "%')";
        ...
        String query = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_BUSINESSTYPE";
