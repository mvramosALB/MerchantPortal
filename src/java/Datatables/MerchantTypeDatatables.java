 ...
 */
public class MerchantTypeDatatables extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] columnNames = {"ID","MT_DESCRIPTION", "ACTIVESTATUS"};
        ...
        try {
            ...
            Logger.getLogger(MerchantTypeDatatables.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public int getTotalRecordCount() throws SQLException, ClassNotFoundException {
        ...
        int totalRecords = -1;
        String sql = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_MERCHANTTYPE" + "";
    ...
    public JSONObject getPersonDetails(int totalRecords, HttpServletRequest request)
        ...
        con = DBConnection.getConnection();
        String sql = "select * from VW_MERCHANTTYPE";

        String globeSearch = " where (MT_DESCRIPTION like '%" + GLOBAL_SEARCH_TERM + "%')";
        ...
        while (rs.next()) {
            ...
            ja.put(rs.getString("MT_DESCRIPTION"));
        ...
        String query = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_MERCHANTTYPE";
