 ...
 */
public class MerchantClassDatatables extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] columnNames = {"ID","MC_DESCRIPTION", "ACTIVESTATUS"};
        ...
        try {
            ...
            Logger.getLogger(MerchantClassDatatables.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public int getTotalRecordCount() throws SQLException, ClassNotFoundException {
        ...
        int totalRecords = -1;
        String sql = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_MERCHANTClass" + "";
    ...
    public JSONObject getPersonDetails(int totalRecords, HttpServletRequest request)
        ...
        con = DBConnection.getConnection();
        String sql = "select * from VW_MERCHANTClass";

        String globeSearch = " where (MC_DESCRIPTION like '%" + GLOBAL_SEARCH_TERM + "%')";
        ...
        while (rs.next()) {
            ...
            ja.put(rs.getString("MC_DESCRIPTION"));
        ...
        String query = "SELECT " + "COUNT(*) as count " + "FROM " + " VW_MERCHANTClass";
