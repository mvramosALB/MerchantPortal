 ...
 */
public class RejectedDisapprovedMerchantDatatables extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
     ...
     //   ProcessStatusFilter = request.getParameter("Process");
        if (pageNo != null) {
        ...
        try {
            ...
            Logger.getLogger(RejectedDisapprovedMerchantDatatables.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public int getTotalRecordCount() throws SQLException, ClassNotFoundException {
        ...
        int totalRecords = -1;
        String sql = "SELECT " + "COUNT(*) as count " + "FROM " + " vw_rejected_merchants" + "";
    ...
    public JSONObject getPersonDetails(int totalRecords, HttpServletRequest request)
        ...
        con = DBConnection.getConnection();
        String sql = "select * from vw_rejected_merchants";
        ...
        while (rs.next()) {
            ...
            ja.put(rs.getString("ActionBy"));//6
            ja.put(rs.getString("ActionDate"));//7
            ja.put(rs.getString("remarks"));//8
            ja.put(rs.getString("status"));//8
            array.put(ja);
        }
        stmt.close();
        rs.close();

        String query = "SELECT " + "COUNT(*) as count " + "FROM " + " vw_rejected_merchants";
